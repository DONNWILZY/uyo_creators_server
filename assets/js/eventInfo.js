document.addEventListener('DOMContentLoaded', () => {
  ...
  fetch(`${baseUrl}/api/events/reserve/${eventNumber}`)
    ...
    .then(data => {
      ...
      // Toggle Attendees section
      if (event.displayAttendees) {
        document.getElementById('attendees-section').classList.add('show');
      } else {
        document.getElementById('attendees-section').classList.add('hide');
      }
      ...
      if (event.displaySponsors) {
        document.getElementById('partners-sponsors').classList.add('show');
      } else {
        document.getElementById('partners-sponsors').classList.add('hide');
      }
